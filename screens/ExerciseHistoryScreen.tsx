...
//         return history
//             .filter((entry) => entry.rpe && entry.weight && entry.reps && entry.rpe >= meanRpe)
//             .map((entry) => ({
...
//                 (item) => new Date(item.date).setHours(0, 0, 0, 0) === currentDate
//             );

//             console.log(existingEntry);
//             if (existingEntry) {
//                 // Add the new set to the existing entry
//                 entry = {
//                     setsArray: [
//                         ...existingEntry.setsArray,
//                         {
...
//                     ...existingEntry,
//                 };
//                 const index = history.findIndex((item) => item === existingEntry);
...
//             }
//         } else {
//             // Handle other exercise categories as before
//             entry = {
//                 notes: Notes,
...
//     const bestOneRepMax = (setArrays: Set[] = []) => {
//         console.log(setArrays);
//         return setArrays.reduce((max, set) => {
...
//         exercise?.category == "strength" || exercise?.category == "nsuns" ? (
//             // find best one rep max for all setArrays entries
//             <Text style={styles.oneRepMax}>{`1RM: ${bestOneRepMax(item.setsArray)} kg`}</Text>
//         ) : null;
